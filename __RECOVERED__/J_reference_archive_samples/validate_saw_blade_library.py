HereΓÇÖs a solid, repo-friendly validate_saw_blade_library.py you can drop into scripts/. It performs hard validations (fail build) and soft validations (warnings) and returns a non-zero exit code on failures.
