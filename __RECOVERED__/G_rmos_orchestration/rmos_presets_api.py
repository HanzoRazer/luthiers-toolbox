...
def promote_preset(preset_id: str, body: PromoteRequest):
    ...
    - Ultra-fragile materials (ΓëÑ0.90) blocked from all lanes
    ...
    try:
        ...
        raise
    except Exception:  # WP-1: governance catch-all ΓÇö HTTP endpoint
    ...
    except Exception as e:  # WP-1: keep broad ΓÇö non-critical joblog write
