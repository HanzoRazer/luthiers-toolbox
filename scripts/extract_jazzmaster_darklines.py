#!/usr/bin/env python3
"""
Extract Jazzmaster body using dark lines method
"""
import sys
...
def main():
    ...
    output_path = r"C:\Users\thepr\Downloads\jazzmaster_body_darklines.dxf"
    page_num = 2  # Page 3 (0-indexed)

    print("=" * 60)
    print("Extracting Jazzmaster Body Outline")
    print("=" * 60)
    ...
    for px, py in points:
        x_mm = px * mm_per_px
        y_mm = (height - py) * mm_per_px  # Flip Y for CAD
