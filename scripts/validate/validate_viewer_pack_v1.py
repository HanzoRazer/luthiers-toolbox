#!/usr/bin/env python3
"""
validate_viewer_pack_v1.py (Vendored from tap_tone_pi)
...
Vendored from: tap_tone_pi/scripts/phase2/validate_viewer_pack_v1.py
Source of truth: tap_tone_pi repo
"""
