...
function getTensionClass(tension: number): string {
  if (tension < 13) return 'too-loose'
  if (tension > 16) return 'too-tight'
  return 'good'
}
</script>

<template>
  <div class="tension-calculator">
      ...
      <div class="calc-inputs">
        ...
        <div class="string-inputs">
          ...
          >
            ...
            >
            <div class="string-freq">{{ s.note }} ({{ s.freq }} Hz)</div>
            <div
...
.string-row {
  display: grid;
  grid-template-columns: 80px 100px 150px 100px;
  gap: 12px;
  align-items: center;
  margin-bottom: 8px;
  padding: 8px;
