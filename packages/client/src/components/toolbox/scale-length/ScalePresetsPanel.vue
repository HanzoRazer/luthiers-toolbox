...
<template>
  <div :class="styles.scalePresetsPanel">
    ...
    <div :class="styles.scaleGrid">
      ...
      <div
        :class="styles.scaleCard"
        @click="emit('selectScale', 'baritone')"
      >
        <div :class="styles.scaleName">
          Baritone Scale
        </div>
      ...
      <div
        :class="styles.scaleCard"
        @click="emit('selectScale', 'multiscale')"
      >
        <div :class="styles.scaleName">
          Multi-Scale (Fanned)
        </div>
