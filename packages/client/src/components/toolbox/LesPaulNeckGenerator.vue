  ...
  <div class="p-4 space-y-4">
    ...
    <div v-if="validationWarnings.length > 0" class="p-3 bg-yellow-50 border border-yellow-300 rounded text-sm">
      ...
      <ul class="list-disc list-inside space-y-1">
        <li v-for="warning in validationWarnings" :key="warning.field" :class="{'text-red-600': warning.severity === 'error', 'text-yellow-700': warning.severity === 'warning'}">
          {{ warning.message }}
        </li>
      </ul>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-4">
      ...
      <div class="md:col-span-2 space-y-4">
        <div class="p-4 border rounded">
          <h3 class="font-semibold text-lg mb-3">Blank Dimensions</h3>
          <div class="grid grid-cols-3 gap-3">
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Length (in)</span>
              <input v-model.number="form.blank_length" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Width (in)</span>
              <input v-model.number="form.blank_width" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Thickness (in)</span>
              <input v-model.number="form.blank_thickness" type="number" step="0.0625" class="border p-2 rounded" />
            </label>
          </div>
        </div>

        <div class="p-4 border rounded">
          <h3 class="font-semibold text-lg mb-3">Scale & Dimensions</h3>
          <div class="grid grid-cols-2 gap-3">
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Scale Length (in)</span>
              <input v-model.number="form.scale_length" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Neck Length (in)</span>
              <input v-model.number="form.neck_length" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Nut Width (in)</span>
              <input v-model.number="form.nut_width" type="number" step="0.001" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Heel Width (in)</span>
              <input v-model.number="form.heel_width" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Neck Angle (°)</span>
              <input v-model.number="form.neck_angle" type="number" step="0.1" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Fretboard Radius (in)</span>
              <input v-model.number="form.fretboard_radius" type="number" step="0.5" class="border p-2 rounded" />
            </label>
          </div>
        </div>

        <div class="p-4 border rounded">
          <h3 class="font-semibold text-lg mb-3">C-Profile Shape</h3>
          <div class="grid grid-cols-2 gap-3">
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Thickness @ 1st Fret (in)</span>
              <input v-model.number="form.thickness_1st_fret" type="number" step="0.01" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Thickness @ 12th Fret (in)</span>
              <input v-model.number="form.thickness_12th_fret" type="number" step="0.01" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Radius @ 1st Fret (in)</span>
              <input v-model.number="form.radius_at_1st" type="number" step="0.05" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Radius @ 12th Fret (in)</span>
              <input v-model.number="form.radius_at_12th" type="number" step="0.05" class="border p-2 rounded" />
            </label>
          </div>
        </div>

        <div class="p-4 border rounded">
          <h3 class="font-semibold text-lg mb-3">Headstock</h3>
          <div class="grid grid-cols-3 gap-3">
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Angle (°)</span>
              <input v-model.number="form.headstock_angle" type="number" step="0.5" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Length (in)</span>
              <input v-model.number="form.headstock_length" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Thickness (in)</span>
              <input v-model.number="form.headstock_thickness" type="number" step="0.0625" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Tuner Layout (in)</span>
              <input v-model.number="form.tuner_layout" type="number" step="0.125" class="border p-2 rounded" />
            </label>
            <label class="flex flex-col">
              <span class="text-sm font-medium mb-1">Tuner Diameter (in)</span>
              <input v-model.number="form.tuner_diameter" type="number" step="0.125" class="border p-2 rounded" />
            </label>
          </div>
        </div>

        <div class="p-4 border rounded">
          <h3 class="font-semibold text-lg mb-3">Options</h3>
          <div class="space-y-2">
            <label class="flex items-center gap-2">
              <input v-model="form.include_fretboard" type="checkbox" class="form-checkbox" />
              <span class="text-sm">Include Fretboard Geometry</span>
            </label>
            <label class="flex items-center gap-2">
              <input v-model="form.alignment_pin_holes" type="checkbox" class="form-checkbox" />
      ...
      <div class="space-y-4">
        <div class="p-4 border rounded bg-gray-50">
          <h3 class="font-semibold mb-2">About C-Profile</h3>
        ...
        <div class="p-4 border rounded bg-blue-50">
          <h3 class="font-semibold mb-2">Standard Les Paul Specs</h3>
        ...
        <div v-if="generatedGeometry" class="p-4 border rounded bg-green-50">
          <h3 class="font-semibold mb-2">✅ Geometry Generated</h3>
        ...
        <div class="p-4 border rounded bg-yellow-50">
          <h3 class="font-semibold mb-2">⚠️ CNC Notes</h3>
