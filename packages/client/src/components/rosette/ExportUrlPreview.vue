<template>
  <div class="export-url-preview">
    ...
    <button
      ...
      @click="$emit('copy-gha-workflow-file')"
    >
...
/**
 * ExportUrlPreview.vue
 *
 * Export URL display with copy buttons for various formats.
 * Emits events for each copy action.
 */
defineProps<{
  exportUrl: string
}>()
