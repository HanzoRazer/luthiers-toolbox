/**
 * CamPipeline H7.2 normalization composable.
 */
import { normalizeCamIntent } from '@/services/rmosCamIntentApi'
import type { NormalizationEntry } from './camPipelineTypes'

// ============================================================================
// Types
// ============================================================================

export interface CamPipelineNormalizeReturn {
...
export function useCamPipelineNormalize(): CamPipelineNormalizeReturn {
  /**
   * Deep-walk a pipeline spec and normalize any CamIntent-like objects.
   */
  async function normalizePipelineSpecDeep(spec: any): Promise<{
    normalized: any
    issues: NormalizationEntry[]
  }> {
