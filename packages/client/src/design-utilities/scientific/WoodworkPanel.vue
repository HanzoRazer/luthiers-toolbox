<template>
  <div class="woodwork-content">
    ...
    <!-- Lutherie Geometry -->
    <div
      v-if="activeCategory === 'Geometry'"
      class="woodwork-panel"
    >
      <h3>📐 Lutherie Geometry</h3>
      <LutherieGeometryPanel />
    </div>

    <!-- Stiffness Index -->
    <div
      v-if="activeCategory === 'Stiffness Index'"
      class="woodwork-panel"
    >
      <h3>📊 Tonewood Stiffness Index</h3>
      <StiffnessIndexPanel />
    </div>
...
import LutherieGeometryPanel from './LutherieGeometryPanel.vue'
