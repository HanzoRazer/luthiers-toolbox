/**
 * Generic composable for unit conversion across multiple categories.
 * Supports standard linear conversion via base-unit factor and
 * special-case temperature conversion.
 *
 * Already domain-agnostic — migrated from Toolbox useUnitConverter.
 */
...
export interface UnitDef {
  key: string
  label: string
  /** Multiply by this to convert to the category's base unit. */
  toBase: number
}

export const UNIT_CATEGORIES = [
  'Length', 'Area', 'Volume', 'Mass', 'Temperature', 'Speed', 'Time', 'Data',
] as const
