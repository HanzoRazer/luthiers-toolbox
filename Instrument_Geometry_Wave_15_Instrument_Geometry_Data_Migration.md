docs/Instrument_Geometry/Wave_15_Instrument_Geometry_Data_Migration.md
Title: Wave 15 – Instrument Geometry Data Migration & Asset Canon

Wave 14 = structure + registry + enums
Wave 15 = fill it with real guitar DNA (DXF/DWG + vibe sandbox specs).

Here’s a ready-to-drop version of that file:
...
InstrumentModelId + instrument_model_registry.json + geometry core are consistent:

All IDs match.

All Tier 1/Tier 2 models have real scale/neck/bridge data.

For Strat, Les Paul, Dreadnought:
...
GUITAR_MODEL_INVENTORY_REPORT.md is updated:
