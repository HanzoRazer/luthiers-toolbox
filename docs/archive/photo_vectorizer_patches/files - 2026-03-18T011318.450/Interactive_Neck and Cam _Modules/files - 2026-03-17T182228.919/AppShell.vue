...
const activeTab = ref<'workspace' | 'import' | 'parametric' | 'neck' | 'configure'>('workspace')
...
<template>
  <div class="shell">
    <nav class="shell-nav">
      ...
      <div class="nav-tabs">
        <button v-for="tab in ['workspace','import','parametric','neck','configure'] as const" :key="tab"
