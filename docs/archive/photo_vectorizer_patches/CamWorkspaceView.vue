...
import NeckOpPanel       from '@/components/NeckOpPanel.vue'
import GcodePreviewPanel from '@/components/GcodePreviewPanel.vue'
import GateStatusBadge   from '@/components/GateStatusBadge.vue'
import type { GateResult } from '@/components/GateStatusBadge.vue'
