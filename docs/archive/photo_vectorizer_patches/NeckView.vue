...
import NeckTaperPanel          from '@/components/neck/NeckTaperPanel.vue'
import FretboardPanel          from '@/components/neck/FretboardPanel.vue'
import NeckProfilePanel        from '@/components/neck/NeckProfilePanel.vue'
import HeadstockTransitionPanel from '@/components/neck/HeadstockTransitionPanel.vue'
