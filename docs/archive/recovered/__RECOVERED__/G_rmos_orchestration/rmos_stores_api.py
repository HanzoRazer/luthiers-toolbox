...
def get_migration_status():
    ...
    except Exception:  # WP-1: keep broad ΓÇö schema introspection may fail on missing table
        schema_version = None
        schema_applied = None
    ...
    except Exception as e:  # WP-1: keep broad ΓÇö non-critical validation check
