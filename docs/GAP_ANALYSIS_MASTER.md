...
| 2026-03-10 | TBD | Add SVG-to-DXF `/convert` endpoint in geometry router | VINE-02 |
...
| EX-GAP-03 | Explorer 1958 | DXF extents don't match spec dimensions (556×434mm vs 475×460mm) | HIGH |
| SG-GAP-02 | Smart Guitar | DXF X-axis asymmetric — centerline 22.2mm off-center, all cavities shifted | HIGH |
