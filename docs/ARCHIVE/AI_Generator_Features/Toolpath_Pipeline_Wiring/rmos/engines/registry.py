...
class EngineRegistry:
    ...
    def __init__(self):
        ...
        self.feasibility_engine = EngineDescriptor(
            ...
            engine_id="feas_v1",
            version="1.0.0",
            impl="app.rmos.feasibility_scorer:score_design_feasibility",
        ...
        self.toolchains: Dict[str, EngineDescriptor] = {
            ...
            "saw_cam_v1": EngineDescriptor(
                kind="toolchain",
                engine_id="saw_cam_v1",
                version="1.0.0",
                impl="app.rmos.toolpaths:generate_toolpaths_server_side",
                description="Saw Lab CAM toolpath generator",
            ),
        }
        ...
        self.post_processors: Dict[str, EngineDescriptor] = {
            "grbl_post_v2": EngineDescriptor(
                ...
                description="GRBL post-processor (ShapeOko, X-Carve, OpenBuilds)",
            ),
            "fanuc_post_v1": EngineDescriptor(
                ...
                description="FANUC post-processor (0i, 16i, 18i, 21i, 30i series)",
            ),
        }
