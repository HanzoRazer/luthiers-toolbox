"""add_runs_v2_and_ai_graphics_tables
...
def upgrade() -> None:
    ...
    op.create_table('run_artifacts',
        ...
        sa.Column('has_advisory_inputs', sa.Boolean(), nullable=False),
    ...
    # Run Advisory Attachments (junction table)
    ...
    op.create_index('ix_ai_fingerprints_hash', 'ai_fingerprints', ['fingerprint_hash'])
    ...
    op.create_index('ix_ai_image_assets_rating', 'ai_image_assets', ['rating'])
