...
| File | Purpose |
|------|---------|
| [`ANNOTATED_LECTURE_NOTES.md`](./ANNOTATED_LECTURE_NOTES.md) | Classified teaching points PM01–PM36 |
| [`CROSSWALK_TOOLBOX.md`](./CROSSWALK_TOOLBOX.md) | Toolbox / Gore / Somogyi / Nicoletti intersections |
| [`GAPS_NOT_RECORDED.md`](./GAPS_NOT_RECORDED.md) | Missing metrics, slide tables, video URL |
...
| **EO** | Empirical / on-stage observation |
| **DH** | Dominic Howman method / recommendation (as spoken here) |
| **IS** | Overlap with Somogyi-style framing (cross-tag only) |
