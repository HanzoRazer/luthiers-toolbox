...
| Holmberg — Gore/Gilet modeling spreadsheets | [`holmberg_gore_modeling_spreadsheets/`](./holmberg_gore_modeling_spreadsheets/) | **Implementation cousin** (not a lecture): Google Sheets of Design eqs — panel \(f\)→t, nut/saddle Δ, 4-DOF FRF/SPL, experimental braces; HM01–HM42; **G-HM03/04** |
