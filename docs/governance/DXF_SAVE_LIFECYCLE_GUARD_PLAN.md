...
| `cam/dxf_consolidator.py` | R2000 | runtime_service | GUARD_ADDED → RETIRED (dead, prefer `layer_consolidator`, parity not asserted; BACKLOG item 9) |
...
| 4 | `cam/dxf_consolidator.py` | create_document | DxfWriter guard | RETIRED (dead, prefer `layer_consolidator`, parity not asserted; BACKLOG item 9) |
