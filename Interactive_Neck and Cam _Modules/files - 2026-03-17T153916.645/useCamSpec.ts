...
// ─── Defaults — dimensions verified against cam/neck/config.py ───────────────
// TrussRodConfig defaults in the repo:
//   width_mm:        6.35   (1/4" standard)
//   depth_mm:        9.525  (3/8" standard)
//   length_mm:       406.4  (16" — nut to ~12th fret area)
//   start_offset_mm: 12.7   (1/2" from nut)
//   access_pocket_width_mm: 12.7 (wider at nut end for wrench access)
...
const DEFAULT_SPEC: CamSpec = {
  ...
  rodAccess:    'heel',
  rodType:      'single',
  rodWidthMm:   6.35,    // 1/4" — from repo TrussRodConfig
  rodDepthMm:   9.525,   // 3/8" — from repo TrussRodConfig
  rodLengthMm:  406.4,   // 16"  — from repo TrussRodConfig
  endMillMm:    3.175,   // 1/8" flat end — repo default tool T2
  tunerPattern: '3+3',
  postDiamMm:   10,
  postCCmm:     35,
  screwDiamMm:  3,
