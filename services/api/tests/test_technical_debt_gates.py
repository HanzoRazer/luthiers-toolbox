...
# (POST /api/cam/projects/{project_id}/adaptive-plan). Ratchet updated accordingly.
TARGET_MAX_ENDPOINTS = 1222  # Actual: 1222 after SPINE-003 governed endpoint; was 1221.
...
ACCEPTABLE_GOD_OBJECTS = {
    ...
    "LTBLuthierCalculator",  # Restored calculator model
