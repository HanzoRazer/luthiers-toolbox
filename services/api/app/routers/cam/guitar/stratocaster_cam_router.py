"""Stratocaster CAM Router — CAM operations for Stratocaster guitars.

Provides:
- GET /templates - List DXF templates
- GET /bom - Bill of materials with cost estimates
- GET /preview - SVG preview of body outline
...
# Base path to Stratocaster project assets
