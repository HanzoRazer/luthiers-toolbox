...
Provides:
- POST /boss/gcode - Generate boss probe G-code
- POST /boss/gcode/download - Download (DRAFT lane)
- POST /boss/gcode/download_governed - Download (GOVERNED lane with RMOS)

Total: 3 routes for boss/hole circular probing.
"""
