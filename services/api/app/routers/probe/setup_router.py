"""Setup Sheet Router - SVG setup sheets and pattern listing.

Provides:
- POST /setup_sheet/svg - Generate SVG setup sheet for probing pattern
- GET /patterns - List all available probing patterns

Total: 2 routes for setup documentation and pattern discovery.
"""
