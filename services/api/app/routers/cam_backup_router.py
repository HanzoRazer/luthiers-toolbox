# File: routers/cam_backup_router.py
...
from app.services.cam_backup_service import BACKUP_DIR, ensure_dir, write_snapshot

router = APIRouter(prefix="/cam/backup", tags=["cam", "backup"])
