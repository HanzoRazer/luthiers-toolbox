"""
Rosette Preset Definitions — Preset data/constants (matrix formulas).

Each preset is a historical or modern matrix formula for rosette ring fabrication.
Extracted from presets.py during decomposition; presets.py is now a re-export shim.
"""
