"""Drill Modal Router - Basic G81/G83 drilling cycles.

Provides:
- POST /gcode - Generate drilling G-code using modal cycles
- GET /info - Get drilling operation information

Total: 2 routes for basic modal drilling.
