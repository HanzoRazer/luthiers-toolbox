"""Benchmark Router — CAM algorithm benchmarking endpoints.

Provides:
- POST /offset_spiral.svg - Generate inward offset spiral toolpath (SVG)
...
__all__ = ["router", "SpiralReq", "TrochReq", "BenchReq"]
