...
Summary, export, and import endpoints for settings hub.

Migrated from: routers/cam_settings_router.py

Architecture Layer: ROUTER (Layer 6)
See: docs/governance/ARCHITECTURE_INVARIANTS.md

Endpoints:
    GET  /summary    - Settings summary counts
    GET  /export     - Export full CAM configuration
    POST /import     - Import full CAM configuration
"""
