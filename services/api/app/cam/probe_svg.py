...
class ProbeSetupSheet:
    ...
    def add_rectangle_part(self, x: float, y: float, width: float, height: float):
    ...
    def add_circle_part(self, cx: float, cy: float, diameter: float):
    ...
    def add_probe_point(self, x: float, y: float, label: str = "", radius: float = 5.0):
    ...
    def add_origin_marker(self, x: float, y: float, label: str = "X0 Y0"):
    ...
    def add_dimension_line(self, x1: float, y1: float, x2: float, y2: float, label: str, offset: float = 20.0):
    ...
    def add_note_box(self, x: float, y: float, lines: List[str], width: float = 250.0, line_height: float = 16.0):
...
def generate_corner_outside_sheet(part_width: float = 100.0, part_height: float = 60.0, probe_offset: float = 20.0) -> str:
    """
    ...
    sheet.add_probe_point(probe_x_left, part_y + 40, "P1: +X Low")
    sheet.add_probe_point(probe_x_left, part_y + part_height * 2 - 40, "P2: +X High")
    sheet.add_probe_point(part_x + 40, probe_y_bottom, "P3: +Y Left")
    sheet.add_probe_point(part_x + part_width * 2 - 40, probe_y_bottom, "P4: +Y Right")
...
def generate_pocket_inside_sheet(pocket_width: float = 100.0, pocket_height: float = 60.0, origin_corner: str = "lower_left") -> str:
    """
