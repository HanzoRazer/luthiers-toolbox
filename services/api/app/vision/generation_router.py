"""Vision Generation Router - AI Image Generation Endpoints.

Provides:
- GET /providers - List AI image providers
- POST /generate - Generate images via AI
- GET /vocabulary - Get vocabulary for UI dropdowns
- POST /prompt - Preview engineered prompt
- POST /feedback - Deprecated (use RMOS review/promote)

LANE: PRODUCER (generates assets via AI, writes to CAS)
"""
...
router = APIRouter(tags=["Vision", "Generation"])
