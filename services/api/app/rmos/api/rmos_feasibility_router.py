...
def compute_profiling_feasibility(
    *,
    ...
    RMOS-PROFILING-CONVERGE-001. Maps the existing scorer's
    low/medium/high/blocked vocabulary onto GREEN/YELLOW/RED so
    ``SafetyPolicy`` can consume it. Feasible-with-warnings stays YELLOW
