"""
Constraint-aware rosette candidate generator (Canonical)

Produces structured RosetteParamSpec candidates within constraint bounds.
This implements the actual generation logic for the RMOS generator factory.

Migrated from: _experimental/ai_core/structured_generator.py (December 2025)
"""
...
from .constraints import RosetteGeneratorConstraints
...
def generate_constrained_candidate(
    *,
    ...
    Note:
        This is DOMAIN logic (RMOS rosette generation).
        It does NOT call external AI APIs directly.
        For AI-powered generation, use app.ai.transport layer.
    """
    deterministic = False
