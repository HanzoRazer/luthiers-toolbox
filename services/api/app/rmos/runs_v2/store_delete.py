...
def execute_delete(
    *,
    ...
    if check_rate_limit is not None:
        ...
        except Exception as e:  # Intentional broad catch: check_rate_limit is a pluggable callback that may raise any exception; we log and re-raise (fail closed). WP-3 AUDITED 2026-03
