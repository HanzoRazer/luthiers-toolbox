...
def record_operator_feedback_event(
    *,
    ...
    # Candidate suggestion (super conservative)
    suggested = {}
    if burn:
    ...
    # Optional: include tool/material hints if the execution payload carries them
    try:
    ...
    # Best-effort JSONL append (never fail the request because the file cannot be written)
    try:
