...
def build_artifact_ref_from_run(
    ...
    *,
    ...
    Only ``associated_at`` / ``project_revision`` are project-side association metadata.
    """
...
def retrieve_project_artifacts(project: Any) -> list[ProjectArtifactRef]:
    ...
    return list(state.manufacturing_artifacts) if state else []
