# services/api/app/projects/_model_defaults.py
"""
Model-specific design-state defaults for InstrumentProjectData (GEN-1 / GEN-2).

Extracted from service.py to keep the core persistence layer under its line-count
budget while giving model-defaults logic its own module.
