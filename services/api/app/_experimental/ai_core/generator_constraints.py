# services/api/app/ai_core/generator_constraints.py
"""
Constraint adapter for AI rosette generation.
Thin wrapper around RMOS constraint profile registry.
"""
...
def constraints_from_context(ctx: RmosContext) -> RosetteGeneratorConstraints:
    ...
    """
    try:
        from ..rmos.constraint_profiles import resolve_constraints_for_context
