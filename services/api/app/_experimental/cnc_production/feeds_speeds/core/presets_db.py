...
def _load_file(path: Path) -> None:
    ...
    except (OSError, json.JSONDecodeError, ValueError) as exc:  # WP-1: narrowed from except Exception  # pragma: no cover
    ...
    for key, payload in presets.items():
        ...
        except (ValueError, TypeError, KeyError) as exc:  # WP-1: narrowed from except Exception
