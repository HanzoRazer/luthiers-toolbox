"""Fraction Calculator - The Production Shop"""
...
class LTBFractionCalculator(LTBBasicCalculator):
    ...
    def set_precision(self, precision: int) -> 'LTBFractionCalculator':
    ...
    def set_fraction_mode(self, enabled: bool = True) -> 'LTBFractionCalculator':
        """Enable or disable fraction display mode."""
        self._fraction_mode = enabled
        return self
    
    def toggle_fraction_mode(self) -> 'LTBFractionCalculator':
    ...
    def fraction(self, numerator: int, denominator: int = 1) -> 'LTBFractionCalculator':
        """Enter a fraction."""
        if denominator == 0:
    ...
    def mixed_number(self, whole: int, numerator: int, denominator: int) -> 'LTBFractionCalculator':
    ...
    def eighth(self, n: int) -> 'LTBFractionCalculator':
        """Enter n/8."""
        return self.fraction(n, 8)
    
    def sixteenth(self, n: int) -> 'LTBFractionCalculator':
        """Enter n/16."""
        return self.fraction(n, 16)
    
    def thirtysecond(self, n: int) -> 'LTBFractionCalculator':
        """Enter n/32."""
        return self.fraction(n, 32)
    
    def quarter(self, n: int = 1) -> 'LTBFractionCalculator':
        """Enter n/4."""
        return self.fraction(n, 4)
    
    def half(self, n: int = 1) -> 'LTBFractionCalculator':
        """Enter n/2."""
    ...
    def feet_inches(self, feet: int, inches: float = 0, 
                    frac_num: int = 0, frac_denom: int = 1) -> 'LTBFractionCalculator':
...
from .fraction_calculator_cli import run_tests, calculator_repl  # noqa: F401
