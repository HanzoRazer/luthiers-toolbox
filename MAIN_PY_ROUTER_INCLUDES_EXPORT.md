# Main.py Router Include Section Export
...
| Wave/Category | Router Count | Notes |
|---------------|--------------|-------|
| Core CAM | 11 | sim, feeds, geometry, tooling, adaptive, machine, cam_opt, material, metrics, logs, learn |
| RMOS 2.0 | 4 | rmos_router, ai, profiles, history |
| CAM Subsystem | 8 | vcarve, post, smoke, relief, svg, helical, backplot, adaptive_preview |
| Pipeline & Presets | 2 | pipeline_presets, dxf_plan |
| Blueprint Import | 1 | blueprint_cam_bridge |
| Machine & Post Config | 3 | machines, machines_tools, posts |
| Instrument Geometry | 1 | instrument_geometry |
| Data Registry | 1 | registry |
| Saw Lab | 1 | saw_debug |
| Specialty Modules | 4 | archtop, stratocaster, smart_guitar, om |
| G-Code Generators | 2 | body_generator, neck_generator |
| CAD Engine | 1 | cad_dxf |
| Rosette System | 2 | rosette_pattern, art_studio_rosette |
| Smart Guitar Temperaments | 1 | temperament |
| Wave 7 | 3 | calculators, cam_fret_slots, bridge |
| Wave 8 | 7 | unified_presets, strip_family, rmos_patterns, rmos_saw_ops, sim_metrics, retract, rosette_photo |
| Wave 9 | 8 | ai_cam*, drill_pattern, roughing, compare, dxf_preflight, joblog*, neck, parametric_guitar |
| Wave 10 | 8 | instrument, compare_lab, drilling, cam_risk, job_risk, learn*, learned_overrides*, cam_backup |
| Wave 11 | 8 | analytics*, advanced_analytics*, probe, ltb_calculator, dashboard*, cam_settings, cam_biarc, job_intelligence |
| Wave 12 | 8 | adaptive_benchmark, fret_slots_export, cam_risk_aggregate, compare_risk_aggregate, compare_risk_bucket_detail, polygon_offset, job_insights, pipeline_preset |
| Wave 13 | 10 | art_presets, cam_compare_diff, cam_dxf_adaptive, cam_pipeline_preset_run, cam_polygon_offset, cam_simulate, compare_automation, compare_risk_bucket_export, health_ext, live_monitor |
| CNC Production | 1 | cnc_compare_jobs |

*\* = Optional (loaded with try/except)*

---

## Broken Routers (Listed in Header Comment)

These routers exist but fail to load due to missing dependencies:
